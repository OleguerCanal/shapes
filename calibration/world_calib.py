    ...
    def __gather_points_pairs(self):
        ...
        for i in range(6):
            ...
            for j in range(1):
                ...
                # elif gs_id == 2:
                #     point = self.getCoord(gs2_list[0])
                point = gs_point_list[30+i]
                # print point

                mc.append((point, gs_id, gripper_state, point_list[10+i][0], point_list[10+i][1], point_list[10+i][2]))
        return mc
...
if __name__ == "__main__":
    ...
    cts = [0.066300455974642375, 3.4118219409555308e-08, -0.049519826556861705, 3.3340313843677488e-06, 4.9329946602492054, 14.0801876193159039, 15.765452354724577]
    ...
    path = 'pos_calibration/pos_calibration_line'
    point = (369.82258064516122, 243.37096774193546)
    point_wb = pc.test(point, path, 2, cts)
    print point_wb
    dif = point_wb - (1169.7, 254.69, 427.71)
    print dif
    print np.linalg.norm(dif)
